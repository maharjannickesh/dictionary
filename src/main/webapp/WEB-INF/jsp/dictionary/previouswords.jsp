...
<div class="mainbody container">
	...
	<div id="wordarea">
		<c:forEach items="${word}" var="words">
			...
			<br>
			<p>
				(<em>${words.wordtype }</em> ) : ${words.definition } &nbsp; &nbsp; <a href="<spring:url value="word/delete/${words.id}" />"><i class="glyphicon glyphicon-trash"></i></a>
			</p>

		</c:forEach>
		<p class="small">You searched for <em>${searchword}</em> <a href='<spring:url value="/addword"></spring:url>'>Search Again</a></p>
	</div>
	

	<form:form commandName="dictionary"
		cssClass="form-horizontal addwordForm col-md-9"
		action="/Dictionary/saveword">
